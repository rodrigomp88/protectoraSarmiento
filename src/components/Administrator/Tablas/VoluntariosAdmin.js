...
const Test = () => {
  ...
  return (
    <div className="container text-center">
      <div className="mt-5">
        <Link to="/Admin">
          <button type="button" className="btn-danger p-2 mt-3 rounded m-2">
            <i class="fa fa-arrow-left"></i> Volver a administrar
          </button>
        </Link>
            ...
            <TableBody>
              {links.map((link) => (
                <StyledTableRow key={link.id}>
                  ...
                  <StyledTableCell align="center">{link.name}</StyledTableCell>
                  <StyledTableCell align="center">{link.age}</StyledTableCell>
                  <StyledTableCell align="center">{link.email}</StyledTableCell>
                  <StyledTableCell align="center">
                    {link.address}
                  </StyledTableCell>
                  <StyledTableCell align="center">
